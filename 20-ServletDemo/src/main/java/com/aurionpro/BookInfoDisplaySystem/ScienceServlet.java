...
@WebServlet(urlPatterns = "/science", initParams = { @WebInitParam(name = "totalScienceVisits", value = "0"),

})
public class ScienceServlet extends HttpServlet {
	private int totalScienceVisits;

	@Override
	public void init(ServletConfig config) throws ServletException {
		super.init(config);

		totalScienceVisits = Integer.parseInt(config.getInitParameter("totalScienceVisits"));
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		out.println("<h1>BookVerse - Science Category Info</h1>");
		out.println("<table>");
		out.println("<tr><th>Property</th><th>Value</th></tr>");
		out.println("<tr><td>Book Category</td><td>Science</td></tr>");
		...
		out.println("<tr><td>Science Books Visited</td><td>" + totalScienceVisits + "</td></tr>");
		out.println("<tr><td>Total Visitors</td><td>" + totalVisits + "</td></tr>");
		out.println("<tr><td>App Version</td><td>1.2.3</td></tr>");
		out.println("</table>");

		out.println("<br><br>");
		out.println("<form action='" + req.getContextPath() + "/admin/science' method='get' style='display:inline;'>");
