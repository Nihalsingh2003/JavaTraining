	...
	public static void main(String[] args) {
		...
		while (true) {
			try {
				...
				System.out.println("4.Search Guitar by Specifications");
				...
				case 3:
					if (list.getGuitarData().isEmpty()) {
						...
						List<Guitar> newList = list.getGuitarData(serialNumber);
						if (newList.isEmpty()) {
							System.out.println("No guitars found matching the SerialNumber");
							break;
						} else {
				...
				case 4:
					...
					if (results.isEmpty()) {
						...
						for (Guitar guitar : results) {
							...
							System.out.println(" We have a " + spec.getBuilder() + " " + spec.getModel() + " "
									+ spec.getType() + " guitar:");
							System.out.println(spec.getBackWood() + " back and sides,");
							System.out.println(spec.getTopWood() + " top.");
					...
					break;
				case 5:
					System.out.println("Thank you for using the Guitar App! Bye 👋");
					scanner.close();
					System.exit(0);
				default:
